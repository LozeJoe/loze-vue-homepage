...
<template>
  <div class="min-h-screen relative overflow-hidden flex items-center justify-center"
    ...
    <div class="relative z-10 text-center px-4">
      ...
      <h2 class="text-2xl md:text-3xl font-bold text-gray-800 mb-3">页面不存</h2>
...
@keyframes float-shard {
  ...
  50% { transform: translateY(-15px) rotate(calc(var(--tw-rotate, 0deg) + 10deg)); }
}
